...
const navigation = {
  ...
  management: [
    { name: "Attendance", href: "/attendance", icon: CheckCircle, current: false },
    { name: "API Integrations", href: "/api-integrations", icon: Zap, current: false },
    { name: "User Management", href: "/user-management", icon: Shield, current: false },
  ],
  administration: [
  ...
  return (
    <aside className="w-64 bg-white shadow-sm min-h-screen border-r border-gray-200">
      <nav className="mt-6">
        ...
        <div className="px-3 mt-8">
          <p className="text-xs font-semibold text-secondary-400 uppercase tracking-wider mb-3">Management</p>
          <ul className="space-y-1">
